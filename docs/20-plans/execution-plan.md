...
作成日: 2026-07-26 / 現在地: **Phase 1.9 評価期間中（2026-07-26 〜 2026-09-26）**

> **家族版はリリース済み。** Supabase + Vercel で稼働、keepalive も疎通確認済み。
> ゲートは `gate-resume.md` に集約し、Googleカレンダーに登録済み（8/26 中間チェック・9/26 GO/NO-GO）。
...
| 1.9 | 評価期間 | 2ヶ月 | 0円 |
| 1.5 | 記事フィード | 2ヶ月 | **約3,800円/月**（Supabase Pro） |
| 2 | 課金（Stripe） | 1ヶ月 | 約6,800円/月（＋Vercel Pro） |
| 3 | 法務・公開 | 2週間 | ドメイン代 |
