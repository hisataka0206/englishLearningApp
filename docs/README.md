...
> **★ 上位の決定は、波及する全部の節に書くこと。**
> 2026-07-26、「発音評価を家族版に含める」という決定を `10-specs/family-edition-spec.md` §1 に書いたまま
> §4・§5・§12・§13 に伝播させなかったため、**それを基数にしている `10-specs/saas-diff-spec.md` の差分総量が全項目ズレ、
> さらに事業計画の原価モデルから Azure の費用が丸ごと抜けた**（`40-tests/spec-review-family-saas.md`）。
> **家族版仕様を改訂したら、差分仕様書 §1.2 の基数を必ず引き直す。**
